...
# A utility to kill the test.py runner in case a multiprocessing assumption
...
def setup_autokill(module_name, timeout=30):
    """Timeout based suiciding thread to kill the test.py runner process
...
with_dev_shm = skipif(
    ...
    reason='This test.py requires a large /dev/shm shared memory fs.')
