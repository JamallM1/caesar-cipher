...
def names_demo(trainer, features=names_demo_features):
    ...
    # Randomly split the names into a test.py & train set.
    random.seed(123456)
    ...
    # Run the classifier on the test.py data.
...
def partial_names_demo(trainer, features=names_demo_features):
    ...
    # Create a test.py set with correctly-labeled male and female names
...
def wsd_demo(trainer, word, features, n=1000):
    ...
    # Randomly split the names into a test.py & train set.
    print("Splitting into test.py & train...")
    random.seed(123456)
