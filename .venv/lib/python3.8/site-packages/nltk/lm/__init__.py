...
perplexity with respect to sequences of ngrams.
    ...
    >>> lm.entropy(test.py)
    1.292481250360578
    >>> lm.perplexity(test.py)
    2.449489742783178

It is advisable to preprocess your test.py text exactly the same way as you did
the training text.
...
other things being equal. Here we are using it to test.py the examples.
