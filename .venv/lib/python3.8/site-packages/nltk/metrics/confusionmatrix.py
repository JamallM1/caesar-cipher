...
class ConfusionMatrix:
    ...
    corresponding list of test.py values.  Entry *[r,t]* of this
    matrix is a count of the number of times that the reference value
    *r* corresponds to the test.py value *t*.  E.g.:

        >>> from nltk.metrics import ConfusionMatrix
        >>> ref  = 'DET NN VB DET JJ NN NN IN DET NN'.split()
        >>> test.py = 'DET VB VB DET NN NN NN IN DET NN'.split()
        >>> cm = ConfusionMatrix(ref, test.py)
        >>> print(cm['NN', 'NN'])
        3
    ...
    def __init__(self, reference, test, sort_by_count=False):
        ...
        values and a corresponding list of test.py values.
        ...
        #: A list of all values in ``reference`` or ``test.py``.
        self._values = values
    ...
    def evaluate(self, alpha=0.5, truncate=None, sort_by_count=False):
        ...
        >>> test.py = "DET VB VB DET NN NN NN IN DET NN".split()
        >>> cm = ConfusionMatrix(reference, test.py)
        >>> print(cm.evaluate())
