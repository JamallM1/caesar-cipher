...
def presence(label):
    """Higher-order function to test.py presence of a given label"""
...
def jaro_winkler_similarity(s1, s2, p=0.1, max_l=4):
    ...
    This test.py-case proves that the output of Jaro-Winkler similarity depends on
