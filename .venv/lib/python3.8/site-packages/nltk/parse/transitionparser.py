...
class TransitionParser(ParserI):
    ...
    def parse(self, depgraphs, modelFile):
        """
        :param depgraphs: the list of test.py sentence, each sentence is represented as a dependency graph where the 'head' information is dummy
...
def demo():
    ...
    Remove test.py temporary files
