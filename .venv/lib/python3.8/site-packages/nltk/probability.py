...
class ProbDistI(metaclass=ABCMeta):
    ...
    def __init__(self):
        """
        Classes inheriting from ProbDistI should implement __init__.py.
        """
...
class ConditionalProbDistI(dict, metaclass=ABCMeta):
    ...
    def __init__(self):
        """
        Classes inheriting from ConditionalProbDistI should implement __init__.py.
        """
...
class ProbabilisticMixIn:
    ...
    parent classes.  For example:
        ...
        >>> class A:
        ...     def __init__.py(self, x, y): self.data = (x,y)
        ...
        >>> class ProbabilisticA(A, ProbabilisticMixIn):
        ...     def __init__.py(self, x, y, **prob_kwarg):
        ...         A.__init__.py(self, x, y)
        ...         ProbabilisticMixIn.__init__.py(self, **prob_kwarg)

    See the documentation for the ProbabilisticMixIn
    ``constructor<__init__.py>`` for information about the arguments it
    expects.
