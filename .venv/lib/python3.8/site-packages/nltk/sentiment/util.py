...
def split_train_test(all_instances, n=None):
    """
    Randomly split `n` instances of the dataset into train and test.py sets.
    ...
    :param n: the number of instances to consider (in case we want to use only a
        subset).
    :return: two lists of instances. Train set is 8/10 of the total and test.py set
...
def demo_tweets(trainer, n_instances=None, output=None):
    """
    Train and test.py Naive Bayes classifier on 10000 tweets, tokenized using
    TweetTokenizer.
    ...
    # uniform class distribution in both train and test.py sets.
...
def demo_subjectivity(trainer, save_analyzer=False, n_instances=None, output=None):
    """
    Train and test.py a classifier on instances of the Subjective Dataset by Pang and
