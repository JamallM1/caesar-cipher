...
class BrillTagger(TaggerI):
    ...
    def print_template_statistics(self, test_stats=None, printunused=True):
        ...
        weighted by score) to the performance on the test.py set. If no test_stats, then
        ...
        def print_testtrain_stats():
            ...
            head = "#ID | Score (test.py) | Score (train) |  #Rules     | Template"
            print(head, "\n", "-" * len(head), sep="")
    ...
    def batch_tag_incremental(self, sequences, gold):
        ...
        single sequence). The point is to collect statistics on the test.py set for
        individual rules.
