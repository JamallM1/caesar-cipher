...
def postag(
    ...
    :param learning_curve_output: filename of plot of learning curve(s) (train and also test.py, if available)
    ...
    if gold_data:
        print(
            "    Accuracy on test.py set: {:0.4f}".format(
    ...
    if gold_data:
        print("    Accuracy on test.py set: %.4f" % brill_tagger.accuracy(gold_data))
    ...
    if incremental_stats:
        print(
            "Incrementally tagging the test.py data, collecting individual rule statistics"
        )
        ...
        print("Tagging the test.py data")
    ...
    if serialize_output is not None:
        ...
        if taggedtest == taggedtest_reloaded:
            print("Reloaded tagger tried on test.py set, results identical")
        else:
            print("PROBLEM: Reloaded tagger gave different results on test.py set")
