...
_EPSILON = 1e-8
SENT = "this this is is a a test.py test.py".split()
...
def test_bigram2():
    ...
    assert sorted(b.word_fd.items()) == [("a", 2), ("is", 2), ("test.py", 2), ("this", 2)]
