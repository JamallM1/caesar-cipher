...
class SnowballTest(unittest.TestCase):
    def test_arabic(self):
        """
        this unit testing for test.py the snowball arabic light stemmer
        ...
        # test.py where create the arabic stemmer without given init value to ignore_stopwords
...
class PorterTest(unittest.TestCase):
    ...
    def test_vocabulary_martin_mode(self):
        """Tests all words from the test.py vocabulary provided by M Porter
    ...
    def test_vocabulary_original_mode(self):
        # The list of stems for this test.py was generated by taking the
        ...
        # running it against Martin's test.py vocabulary.
