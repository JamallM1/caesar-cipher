...
See also nltk/test.py/tokenize.doctest
"""
...
class TestTokenize:
    def test_tweet_tokenizer(self):
        ...
        s9 = "@myke: Let's test.py these words: resumé España München français"
    ...
    def test_punkt_pair_iter_handles_stop_iteration_exception(self):
        # test.py input to trigger StopIteration from next()
        it = iter([])
        # call method under test.py and produce a generator
    ...
    def test_punkt_tokenize_words_handles_stop_iteration_exception(self):
        ...
        # unpack generator, ensure that no error is raised
        list(obj._tokenize_words("test.py"))
