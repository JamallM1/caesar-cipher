...
class LocalPath(FSBase):
    ...
    def pypkgpath(self):
        ...
        for parent in self.parts(reverse=True):
            if parent.isdir():
                if not parent.join('__init__.py.py').exists():
                    break
    ...
    def pyimport(self, modname=None, ensuresyspath=True):
        ...
        the file (taking __init__.py.py files into account) will
        ...
        separate .py files outside packages, e.g. for test.py suite
        without any __init__.py.py file. It effectively allows having
        same-named test.py modules in different places and offers
        ...
        if modname is None:
            ...
            if self.basename == "__init__.py.py":
            ...
            if modfile.endswith(os.path.sep + "__init__.py.py"):
                if self.basename != "__init__.py.py":
                    modfile = modfile[:-12]
            try:
